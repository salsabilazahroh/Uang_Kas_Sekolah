                    ...
                    <div class="row justify-content-center mb-2">
                        ...
                        <div class="col-sm text-right">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#tambahJabatanModal"><i class="fas fa-fw fa-plus"></i> Tambah
                                Jabatan</button>
                            <!-- Modal -->
                            <div class="modal fade text-left" id="tambahJabatanModal" tabindex="-1" role="dialog"
                                    ...
                                    <form method="post">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="btnTambahJabatan"><i
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="ubah_jabatan.php?id_jabatan=<?= $dj['id_jabatan']; ?>"
                                                    class="badge badge-success" data-toggle="modal"
                                                    data-target="#editJabatanModal<?= $dj['id_jabatan']; ?>">
                                                    <i class="fas fa-fw fa-edit"></i> Ubah
                                                </a>
                                                <!-- Modal -->
                                                <div class="modal fade" id="editJabatanModal<?= $dj['id_jabatan']; ?>"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="editJabatanModalLabel<?= $dj['id_jabatan']; ?>"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="editJabatanModalLabel<?= $dj['id_jabatan']; ?>">
                                                                        Ubah Jabatan</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="nama_jabatan<?= $dj['id_jabatan']; ?>">Nama
                                                                            Jabatan</label>
                                                                        <input type="text" name="nama_jabatan"
                                                                            id="nama_jabatan<?= $dj['id_jabatan']; ?>"
                                                                            class="form-control"
                                                                            value="<?= $dj['nama_jabatan']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger"
                                                                        ...
                                                                        Kembali</button>
                                                                    <button type="submit" name="btnEditJabatan"
                                                ...
                                                <a data-nama="<?= $dj['nama_jabatan']; ?>"
                                                    class="btn-delete badge badge-danger"
                                                    href="hapus_jabatan.php?id_jabatan=<?= $dj['id_jabatan']; ?>"><i
