                    ...
                    <div class="row justify-content-center mb-2">
                        ...
                        <div class="col-sm text-right">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#tambahUserModal"><i class="fas fa-fw fa-plus"></i> Tambah User</button>
                            <!-- Modal -->
                            <div class="modal fade text-left" id="tambahUserModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" minlength="6" name="password_verify"
                                                        id="password_verify" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jabatan" class="form-control" id="id_jabatan">
                                                        ...
                                                        <option value="<?= $dj['id_jabatan']; ?>">
                                                            <?= $dj['nama_jabatan']; ?></option>
                                                        <?php endif ?>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="btnTambahUser"><i
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="ubah_user.php?id_user=<?= $du['id_user']; ?>"
                                                    class="badge badge-success" data-toggle="modal"
                                                    data-target="#editUserModal<?= $du['id_user']; ?>">
                                                    <i class="fas fa-fw fa-edit"></i> Ubah
                                                </a>
                                                <!-- Modal -->
                                                <div class="modal fade" id="editUserModal<?= $du['id_user']; ?>"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="editUserModalLabel<?= $du['id_user']; ?>"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="username<?= $du['id_user']; ?>">Username</label>
                                                                        <input type="hidden" name="username"
                                                                            value="<?= $du['username']; ?>">
                                                                        <input style="cursor: not-allowed;" disabled
                                                                            type="text" value="<?= $du['username']; ?>"
                                                                            id="username<?= $du['id_user']; ?>"
                                                                            class="form-control" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="nama_lengkap<?= $du['id_user']; ?>">Nama
                                                                            Lengkap</label>
                                                                        <input type="text" name="nama_lengkap"
                                                                            id="nama_lengkap<?= $du['id_user']; ?>"
                                                                            class="form-control" required
                                                                            value="<?= $du['nama_lengkap']; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="id_jabatan<?= $du['id_user']; ?>">Nama
                                                                            Jabatan</label>
                                                                        <select name="id_jabatan" class="form-control"
                                                                            id="id_jabatan<?= $du['id_user']; ?>">
                                                                            <option value="<?= $du['id_jabatan']; ?>">
                                                                                <?= $du['nama_jabatan']; ?></option>
                                                                            <?php foreach ($jabatan as $dj): ?>
                                                                            <?php if ($dj['id_jabatan'] !== '1'): ?>
                                                ...
                                                <a data-nama="<?= $du['nama_lengkap']; ?>"
                                                    class="btn-delete badge badge-danger"
                                                    href="hapus_user.php?id_user=<?= $du['id_user']; ?>"><i
